...
function App() {
  ...
  let products = [
    ...
    {
      id: 14,
      title: "Samsung 49-Inch CHG90 144Hz Curved Gaming Monitor (LC49HG90DMNXZA) – Super Ultrawide creenQLED ",
      price: 99999,
  ...
  return (
    <div className='flex gap-5 bg-gray-100 min-h-screen p-10'>
      ...
      <div className='flex gap-4 flex-wrap w-[70%]'>
        ...
        {
          products.map((item) => {
            return <Product data={item} updateCart={updateCart} cart={cart}></Product>
          })
        }
          ...
          cart.length > 0 ? (
            ...
            cart.map((item, index) => {
              ...
              return <div className="flex items-center bg-white shadow p-4 rounded-lg h-24 mt-2">
                <div className="text-xl font-bold text-gray-600 mr-4 w-8 text-center">{index + 1}.
                </div>
